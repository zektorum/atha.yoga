...
from lessons.app.http.requests.course_requests import (
    CourseFilterRequest,
    CourseCreateRequest,
    CourseUpdateRequest,
...
from lessons.app.http.resources.course_resources import CourseResource
from lessons.app.repositories.course_repository import CourseRepository
from lessons.app.services.course_service import (
    CourseCreator,
    FavoriteCoursesWork,
    TicketWorkService,
)
